...
| 章节 | 主题 |
|------|------|
| 08 | 分子表征总论：从 1D 到学出来的嵌入 |
| 09 | 化学反应处理：Reaction SMARTS 与虚拟库枚举 |
| 10 | 构象生成与 3D 处理 |
| 11 | 分子骨架、R 基团分解与 MMPA |
| 12 | 化学数据批量工程：PandasTools 与化学空间可视化 |
| 13 | 完整 Pipeline：从原始数据到模型输入 |
...
第一部分（00–07、14、附录 B）**内容已就绪，尚未公开发布**。

第二部分与附录 A 待补。若你希望优先看到某一章，欢迎开 issue 说明，我会据此调整顺序。
